...
"""
This module contains functions that define the LPLC2 models without four individual inhibitory units.
"""
...
def get_output_LPLC2(args, weights_e, intercept_e, UV_flow_t):
    """
...
def get_output_LPLC2_T(args, weights_e, intercept_e, UV_flow, tau_1):
    """
    This function takes the flow field as inputs, and outputs the sum of the responses 
    ...
    output_T = tf.map_fn(lambda x:\
        get_output_LPLC2(args, weights_e, intercept_e, x), \
...
def get_loss_and_prob(args, weights_e, intercept_e, UV_flow, \
                   labels, tau_1, a, b, step_weights, regularizer_we, regularizer_a):
    """
    ...
    regularizer_we, regularizer_a: regularizers on weights_e, and a.
    ...
    """
    output_T = get_output_LPLC2_T(args, weights_e, \
        intercept_e, UV_flow, tau_1) # shape = steps by batch_size
    ...
    loss = loss + regularization_penalty_we + regularization_penalty_a # shape = 0
...
def train_and_test_model(args, train_flow_files, train_labels, test_flow_files, test_labels, \
    ...
    loss, probabilities = \
    get_loss_and_prob(args, weights_e, intercept_e, UV_flow, \
    ...
    if args['restrict_nonneg_weight']:
        with tf.control_dependencies([opt]): # constrained optimization
            ...
            opt_with_clip = tf.group(clip_weights_e)
