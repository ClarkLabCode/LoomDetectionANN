...
for M in [32]:
    ...
    # around_z_angles = np.random.random(M) * 2 * np.pi # rotation angles around the z axis
    ...
    savepath = f'../../data/loom/multi_lplc2_D{np.int(D_min)}_L{np.int(L)}_exp_8fold_M32_random_z_predefined_angle/'
