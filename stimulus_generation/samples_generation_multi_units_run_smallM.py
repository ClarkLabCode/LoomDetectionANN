...
for M in [1, 2, 4, 8, 16, 32, 64, 128]:
    ...
    D_min = 10. * R # minimum initial distance 
    D_max = 10.01 * R # maximum initial distance 
    ...
    savepath = f'../../data/loom/multi_lplc2_D{np.int(D_min)}_L{np.int(L)}_exp_test/'
    ...
    smgnmu.generate_samples_par_exp(M, R, dt, dynamics_fun, eta_1, sigma, theta_r, K, L, sample_dt, delay_dt, \
